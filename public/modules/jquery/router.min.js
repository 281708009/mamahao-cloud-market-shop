 ...
 * 优化：
 * 1. 解决bigpipe方案中原生js代码插入script代码不主动执行的问题，改成jquery
 * 2. 默认enter方法中，容器添加`.spa`标识class
 * 3.判断当前url和请求数据时的url是否一致，不一致则不渲染页面。解决快速点击返回按钮造成页面错乱的问题。
 *
 */
!function (e, t) {
            ...
            return a(e, [{
                key: "init", value: function () {
                    ...
                    window.addEventListener("hashchange", function (t) {
                        e.currURL = t.newURL;
                        //console.log('currURL--->', e.currURL)
                        var n = s.getHash(t.newURL), r = history.state || {};
                        s.getRoute(e._routes, n) ? e.go(n, r._index <= e._index) : e.go(e._default, null);
                    }, !1), history.state && history.state._index && (e._index = history.state._index), e._index--;
                    var t = s.getHash(location.href), n = s.getRoute(e._routes, t);
                    return n ? e.go(n ? t : e._default) : e.go(e._default, null), this
                }
            }, {
                ...
                key: "go", value: function (e) {
                    ...
                    return !function () {
                        var o = function (e) {
                            e && !function () {
                                var e = t._$container.lastChild;
                                $(e).prevAll().remove();
                                n && e.classList.add(t._options.leave), t._options.leaveTimeout > 0 ? setTimeout(function () {
                                    $(e).remove();
                                }, t._options.leaveTimeout) : $(e).remove();
                            }()
                        }, i = function (o, i) {
                            var a = $("<div class='spa'>" + i + "</div>");
                            r.className && a.addClass(r.className),
                                $(t._$container).empty().append(a),
                            !n && t._options.enter && o && a.addClass(t._options.enter), t._options.enterTimeout > 0 ? setTimeout(function () {
                                a.removeClass(t._options.enter)
                            }, t._options.enterTimeout) : a.removeClass(t._options.enter);

                            location.hash = "#" + e;
                            try {
                                n ? t._index-- : t._index++;
                                history.replaceState && history.replaceState({_index: t._index}, "", location.href)
                            } catch (u) {
                            }
                        ...
                        var u = function (e) {
                            if (e)throw e;
                            var html = arguments.length <= 1 || void 0 === arguments[1] ? "" : arguments[1];
                            var info = arguments[2];
                            //console.log('curr--->', t.currURL, ',req--->', info.href)
                            if (t.currURL && info && t.currURL !== info.href) return;
                            o(a);
                            i(a, html)
                        };
                        if (null === n) {
                            //首次进入，如果href不包含'#/',则添加上标识，不触发render函数
                            location.hash = "#" + e;
                            try {
                                n ? t._index-- : t._index++;
                                history.replaceState && history.replaceState({_index: t._index}, "", location.href)
